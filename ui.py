...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.protocolLineEdit.setPlaceholderText(_translate("MainWindow", "Enter Protocol (eg. TCP) ..."))
        self.label_2.setText(_translate("MainWindow", "Source: "))
        self.sourceLineEdit.setPlaceholderText(_translate("MainWindow", "Enter Source IP (eg. 1.1.1.1) ..."))
        self.label_3.setText(_translate("MainWindow", "Destination: "))
        self.destinationLineEdit.setPlaceholderText(_translate("MainWindow", "Enter Destination IP (e.g. 2.2.2.2) ..."))
